...
public final class WmiUtil {
   ...
   public static <T extends Enum<T>> String getString(WbemcliUtil.WmiResult<T> result, T property, int index) {
      if (result.getCIMType(property) == 8) {
         ...
         throw new ClassCastException(
            String.format(
               "%s is not a %s type. CIM Type is %d and VT type is %d", property.name(), "String", result.getCIMType(property), result.getVtType(property)
            )
         );
      }
   }
   ...
   public static <T extends Enum<T>> OffsetDateTime getDateTime(WbemcliUtil.WmiResult<T> result, T property, int index) {
      if (result.getCIMType(property) == 101) {
         ...
         throw new ClassCastException(
            String.format(
               "%s is not a %s type. CIM Type is %d and VT type is %d", property.name(), "DateTime", result.getCIMType(property), result.getVtType(property)
            )
         );
      }
   }
   ...
   public static <T extends Enum<T>> String getRefString(WbemcliUtil.WmiResult<T> result, T property, int index) {
      if (result.getCIMType(property) == 102) {
         ...
         throw new ClassCastException(
            String.format(
               "%s is not a %s type. CIM Type is %d and VT type is %d", property.name(), "Reference", result.getCIMType(property), result.getVtType(property)
            )
         );
      }
   }
   ...
   public static <T extends Enum<T>> long getUint64(WbemcliUtil.WmiResult<T> result, T property, int index) {
      ...
      if (o == null) {
         ...
         throw new ClassCastException(
            String.format(
               "%s is not a %s type. CIM Type is %d and VT type is %d", property.name(), "UINT64", result.getCIMType(property), result.getVtType(property)
            )
         );
      }
   }
   ...
   public static <T extends Enum<T>> int getUint32(WbemcliUtil.WmiResult<T> result, T property, int index) {
      if (result.getCIMType(property) == 19) {
         ...
         throw new ClassCastException(
            String.format(
               "%s is not a %s type. CIM Type is %d and VT type is %d", property.name(), "UINT32", result.getCIMType(property), result.getVtType(property)
            )
         );
      }
   }
   ...
   public static <T extends Enum<T>> long getUint32asLong(WbemcliUtil.WmiResult<T> result, T property, int index) {
      if (result.getCIMType(property) == 19) {
         return getInt(result, property, index) & 4294967295L;
      } else {
         throw new ClassCastException(
            String.format(
               "%s is not a %s type. CIM Type is %d and VT type is %d", property.name(), "UINT32", result.getCIMType(property), result.getVtType(property)
   ...
   public static <T extends Enum<T>> int getSint32(WbemcliUtil.WmiResult<T> result, T property, int index) {
      if (result.getCIMType(property) == 3) {
         ...
         throw new ClassCastException(
            String.format(
               "%s is not a %s type. CIM Type is %d and VT type is %d", property.name(), "SINT32", result.getCIMType(property), result.getVtType(property)
            )
         );
      }
   }
   ...
   public static <T extends Enum<T>> int getUint16(WbemcliUtil.WmiResult<T> result, T property, int index) {
      if (result.getCIMType(property) == 18) {
         ...
         throw new ClassCastException(
            String.format(
               "%s is not a %s type. CIM Type is %d and VT type is %d", property.name(), "UINT16", result.getCIMType(property), result.getVtType(property)
            )
         );
      }
   }
   ...
   public static <T extends Enum<T>> float getFloat(WbemcliUtil.WmiResult<T> result, T property, int index) {
      ...
      if (o == null) {
         ...
         throw new ClassCastException(
            String.format(
               "%s is not a %s type. CIM Type is %d and VT type is %d", property.name(), "Float", result.getCIMType(property), result.getVtType(property)
            )
         );
      }
   }
