...
public class FreeBsdOSThread extends AbstractOSThread {
   ...
   private boolean updateAttributes(Map<FreeBsdOSProcess.PsThreadColumns, String> threadMap) {
      ...
      long elapsedTime = ParseUtil.parseDHMSOrDefault(threadMap.get(FreeBsdOSProcess.PsThreadColumns.ETIMES), 0L);
      ...
      long nonVoluntaryContextSwitches = ParseUtil.parseLongOrDefault(threadMap.get(FreeBsdOSProcess.PsThreadColumns.NIVCSW), 0L);
      long voluntaryContextSwitches = ParseUtil.parseLongOrDefault(threadMap.get(FreeBsdOSProcess.PsThreadColumns.NVCSW), 0L);
