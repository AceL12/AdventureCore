...
public interface Wevtapi extends StdCallLibrary {
   Wevtapi INSTANCE = Native.load("wevtapi", Wevtapi.class, W32APIOptions.UNICODE_OPTIONS);
   ...
   Winevt.EVT_HANDLE EvtSubscribe(
      Winevt.EVT_HANDLE var1, Winevt.EVT_HANDLE var2, String var3, String var4, Winevt.EVT_HANDLE var5, Pointer var6, Callback var7, int var8
   );
   ...
   boolean EvtFormatMessage(
      Winevt.EVT_HANDLE var1, Winevt.EVT_HANDLE var2, int var3, int var4, Winevt.EVT_VARIANT[] var5, int var6, int var7, char[] var8, IntByReference var9
   );
