...
public interface Advapi32 extends StdCallLibrary {
   ...
   int RegCreateKeyEx(
      ...
      int var5,
      int var6,
      WinBase.SECURITY_ATTRIBUTES var7,
      WinReg.HKEYByReference var8,
      IntByReference var9
   );
   ...
   int RegQueryInfoKey(
      ...
      IntByReference var8,
      IntByReference var9,
      IntByReference var10,
      IntByReference var11,
      WinBase.FILETIME var12
   );
   ...
   boolean EnumServicesStatusEx(
      Winsvc.SC_HANDLE var1, int var2, int var3, int var4, Pointer var5, int var6, IntByReference var7, IntByReference var8, IntByReference var9, String var10
   );
   ...
   boolean CreateProcessAsUser(
      ...
      String var2,
      String var3,
      WinBase.SECURITY_ATTRIBUTES var4,
      WinBase.SECURITY_ATTRIBUTES var5,
      boolean var6,
      int var7,
      String var8,
      String var9,
      WinBase.STARTUPINFO var10,
      WinBase.PROCESS_INFORMATION var11
   );
   ...
   int GetSecurityInfo(
      ...
      int var2,
      int var3,
      PointerByReference var4,
      PointerByReference var5,
      PointerByReference var6,
      PointerByReference var7,
   ...
   boolean MakeAbsoluteSD(
      WinNT.SECURITY_DESCRIPTOR_RELATIVE var1,
      WinNT.SECURITY_DESCRIPTOR var2,
      IntByReference var3,
      WinNT.ACL var4,
      IntByReference var5,
      WinNT.ACL var6,
   ...
   boolean AccessCheck(
      ...
      WinNT.HANDLE var2,
      WinDef.DWORD var3,
      WinNT.GENERIC_MAPPING var4,
      WinNT.PRIVILEGE_SET var5,
      WinDef.DWORDByReference var6,
      WinDef.DWORDByReference var7,
      WinDef.BOOLByReference var8
   );
   ...
   Winsvc.SC_HANDLE CreateService(
      Winsvc.SC_HANDLE var1,
      String var2,
      String var3,
      int var4,
      int var5,
