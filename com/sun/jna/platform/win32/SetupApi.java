...
public interface SetupApi extends StdCallLibrary {
   ...
   boolean SetupDiGetDeviceInterfaceDetail(
      WinNT.HANDLE var1, SetupApi.SP_DEVICE_INTERFACE_DATA var2, Pointer var3, int var4, IntByReference var5, SetupApi.SP_DEVINFO_DATA var6
   );

   boolean SetupDiGetDeviceRegistryProperty(
      WinNT.HANDLE var1, SetupApi.SP_DEVINFO_DATA var2, int var3, IntByReference var4, Pointer var5, int var6, IntByReference var7
   );
