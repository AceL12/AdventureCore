...
public interface ITypeInfo extends IUnknown {
   ...
   WinNT.HRESULT Invoke(
      WinDef.PVOID var1,
      OaIdl.MEMBERID var2,
      WinDef.WORD var3,
      OleAuto.DISPPARAMS.ByReference var4,
      Variant.VARIANT.ByReference var5,
      OaIdl.EXCEPINFO.ByReference var6,
      WinDef.UINTByReference var7
   );

   WinNT.HRESULT GetDocumentation(
      OaIdl.MEMBERID var1, WTypes.BSTRByReference var2, WTypes.BSTRByReference var3, WinDef.DWORDByReference var4, WTypes.BSTRByReference var5
   );
