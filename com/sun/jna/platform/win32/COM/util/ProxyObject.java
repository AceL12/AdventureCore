...
public class ProxyObject implements InvocationHandler, IDispatch, IRawDispatchHandle, IConnectionPoint {
   ...
   public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
      ...
      if (declaredAsInterface
         || !method.getDeclaringClass().equals(Object.class)
            ...
            && !method.getDeclaringClass().equals(IDispatch.class)
   ...
   private ConnectionPoint fetchRawConnectionPoint(Guid.IID iid) {
      ...
      COMUtils.checkRC(hr);
      return new ConnectionPoint(ppCp.getValue());
   }
   ...
   private String getMethodName(Method method, ComMethod meth) {
      return meth.name().isEmpty() ? method.getName() : meth.name();
   }
   ...
   @Deprecated
   protected WinNT.HRESULT oleMethod(
      int nType, Variant.VARIANT.ByReference pvResult, com.sun.jna.platform.win32.COM.IDispatch pDisp, String name, Variant.VARIANT pArg
   ) throws COMException {
   ...
   @Deprecated
   protected WinNT.HRESULT oleMethod(
      int nType, Variant.VARIANT.ByReference pvResult, com.sun.jna.platform.win32.COM.IDispatch pDisp, OaIdl.DISPID dispId, Variant.VARIANT pArg
   ) throws COMException {
   ...
   @Deprecated
   protected WinNT.HRESULT oleMethod(
      int nType, Variant.VARIANT.ByReference pvResult, com.sun.jna.platform.win32.COM.IDispatch pDisp, String name, Variant.VARIANT[] pArgs
   ) throws COMException {
   ...
   @Deprecated
   protected WinNT.HRESULT oleMethod(
      int nType, Variant.VARIANT.ByReference pvResult, com.sun.jna.platform.win32.COM.IDispatch pDisp, OaIdl.DISPID dispId, Variant.VARIANT[] pArgs
   ) throws COMException {
      assert COMUtils.comIsInitialized() : "COM not initialized";
      ...
      if (pDisp == null) {
         ...
         WinNT.HRESULT hr = pDisp.Invoke(
            dispId, new Guid.REFIID(Guid.IID_NULL), this.factory.getLCID(), new WinDef.WORD(finalNType), dp, pvResult, pExcepInfo, puArgErr
         );
