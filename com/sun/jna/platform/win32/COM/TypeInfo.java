...
public class TypeInfo extends Unknown implements ITypeInfo {
   ...
   public WinNT.HRESULT Invoke(
      ...
      return (WinNT.HRESULT)this._invokeNativeObject(
         11, new Object[]{this.getPointer(), pvInstance, memid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr}, WinNT.HRESULT.class
      );
   }

   @Override
   public WinNT.HRESULT GetDocumentation(
      OaIdl.MEMBERID memid,
      ...
      return (WinNT.HRESULT)this._invokeNativeObject(
         12, new Object[]{this.getPointer(), memid, pBstrName, pBstrDocString, pdwHelpContext, pBstrHelpFile}, WinNT.HRESULT.class
      );
   }

   @Override
   public WinNT.HRESULT GetDllEntry(
      OaIdl.MEMBERID memid, OaIdl.INVOKEKIND invKind, WTypes.BSTRByReference pBstrDllName, WTypes.BSTRByReference pBstrName, WinDef.WORDByReference pwOrdinal
   ) {
      return (WinNT.HRESULT)this._invokeNativeObject(
         13, new Object[]{this.getPointer(), memid, invKind, pBstrDllName, pBstrName, pwOrdinal}, WinNT.HRESULT.class
      );
   }
