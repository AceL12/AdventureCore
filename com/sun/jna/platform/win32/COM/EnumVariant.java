...
public class EnumVariant extends Unknown implements IEnumVariant {
   ...
   public Variant.VARIANT[] Next(int count) {
      ...
      WinNT.HRESULT hresult = (WinNT.HRESULT)this._invokeNativeObject(
         3, new Object[]{this.getPointer(), resultStaging.length, resultStaging, resultCount}, WinNT.HRESULT.class
      );
