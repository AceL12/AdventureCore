...
public class TypeLib extends Unknown implements ITypeLib {
   ...
   public WinNT.HRESULT GetDocumentation(
      ...
      return (WinNT.HRESULT)this._invokeNativeObject(
         9, new Object[]{this.getPointer(), index, pBstrName, pBstrDocString, pdwHelpContext, pBstrHelpFile}, WinNT.HRESULT.class
      );
   }
   ...
   @Override
   public WinNT.HRESULT FindName(
      WTypes.LPOLESTR szNameBuf, WinDef.ULONG lHashVal, Pointer[] ppTInfo, OaIdl.MEMBERID[] rgMemId, WinDef.USHORTByReference pcFound
   ) {
