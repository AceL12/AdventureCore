...
public class TypeInfoUtil {
   ...
   public TypeInfoUtil.TypeInfoDoc getDocumentation(OaIdl.MEMBERID memid) {
      ...
      COMUtils.checkRC(hr);
      TypeInfoUtil.TypeInfoDoc TypeInfoDoc = new TypeInfoUtil.TypeInfoDoc(
         pBstrName.getString(), pBstrDocString.getString(), pdwHelpContext.getValue().intValue(), pBstrHelpFile.getString()
      );
