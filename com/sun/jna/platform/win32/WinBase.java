...
public interface WinBase extends WinDef, BaseTSD {
   ...
   public static class FILETIME extends Structure {
      ...
      public static Date filetimeToDate(int high, int low) {
         long filetime = (long)high << 32 | low & 4294967295L;
      ...
      public WinDef.DWORDLONG toDWordLong() {
         return new WinDef.DWORDLONG((long)this.dwHighDateTime << 32 | this.dwLowDateTime & 4294967295L);
      }
   ...
   public static class FILE_ATTRIBUTE_TAG_INFO extends Structure {
      ...
      public static int sizeOf() {
         return Native.getNativeSize(WinBase.FILE_ATTRIBUTE_TAG_INFO.class, null);
      }
   ...
   public static class FILE_BASIC_INFO extends Structure {
      ...
      public static int sizeOf() {
         return Native.getNativeSize(WinBase.FILE_BASIC_INFO.class, null);
      }
      ...
      public FILE_BASIC_INFO(
         WinBase.FILETIME CreationTime, WinBase.FILETIME LastAccessTime, WinBase.FILETIME LastWriteTime, WinBase.FILETIME ChangeTime, int FileAttributes
      ) {
      ...
      public FILE_BASIC_INFO(
         WinNT.LARGE_INTEGER CreationTime,
   ...
   public static class FILE_COMPRESSION_INFO extends Structure {
      ...
      public static int sizeOf() {
         return Native.getNativeSize(WinBase.FILE_COMPRESSION_INFO.class, null);
      }
      ...
      public FILE_COMPRESSION_INFO(
         WinNT.LARGE_INTEGER CompressedFileSize, short CompressionFormat, byte CompressionUnitShift, byte ChunkShift, byte ClusterShift
      ) {
   ...
   public static class FILE_DISPOSITION_INFO extends Structure {
      ...
      public static int sizeOf() {
         return Native.getNativeSize(WinBase.FILE_DISPOSITION_INFO.class, null);
      }
   ...
   public static class FILE_ID_INFO extends Structure {
      ...
      public static int sizeOf() {
         return Native.getNativeSize(WinBase.FILE_ID_INFO.class, null);
      }
   ...
   public static class FILE_STANDARD_INFO extends Structure {
      ...
      public static int sizeOf() {
         return Native.getNativeSize(WinBase.FILE_STANDARD_INFO.class, null);
      }
   ...
   public static class WIN32_FIND_DATA extends Structure {
      ...
      public static int sizeOf() {
         return Native.getNativeSize(WinBase.WIN32_FIND_DATA.class, null);
      }
