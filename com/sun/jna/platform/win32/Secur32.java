...
public interface Secur32 extends StdCallLibrary {
   ...
   int AcquireCredentialsHandle(
      String var1, String var2, int var3, WinNT.LUID var4, Pointer var5, Pointer var6, Pointer var7, Sspi.CredHandle var8, Sspi.TimeStamp var9
   );

   int InitializeSecurityContext(
      Sspi.CredHandle var1,
      Sspi.CtxtHandle var2,
      String var3,
      int var4,
      int var5,
      int var6,
      Sspi.SecBufferDesc var7,
      int var8,
      Sspi.CtxtHandle var9,
      Sspi.SecBufferDesc var10,
      IntByReference var11,
      Sspi.TimeStamp var12
   );
   ...
   int AcceptSecurityContext(
      Sspi.CredHandle var1,
      Sspi.CtxtHandle var2,
      Sspi.SecBufferDesc var3,
      int var4,
      int var5,
      Sspi.CtxtHandle var6,
      Sspi.SecBufferDesc var7,
      IntByReference var8,
      Sspi.TimeStamp var9
   );
