...
public final class User32Util {
   public static final EnumSet<Win32VK> WIN32VK_MAPPABLE = EnumSet.of(
      Win32VK.VK_BACK,
      Win32VK.VK_TAB,
      Win32VK.VK_CLEAR,
      Win32VK.VK_RETURN,
      ...
      Win32VK.VK_MULTIPLY,
      Win32VK.VK_ADD,
      Win32VK.VK_SEPARATOR,
      Win32VK.VK_SUBTRACT,
      Win32VK.VK_DECIMAL,
      Win32VK.VK_DIVIDE,
      Win32VK.VK_OEM_NEC_EQUAL,
      Win32VK.VK_OEM_FJ_MASSHOU,
      Win32VK.VK_OEM_FJ_TOUROKU,
      Win32VK.VK_OEM_FJ_LOYA,
      Win32VK.VK_OEM_FJ_ROYA,
      Win32VK.VK_OEM_1,
      Win32VK.VK_OEM_PLUS,
      Win32VK.VK_OEM_COMMA,
      Win32VK.VK_OEM_MINUS,
      Win32VK.VK_OEM_PERIOD,
      Win32VK.VK_OEM_2,
      Win32VK.VK_OEM_3,
      Win32VK.VK_RESERVED_C1,
      Win32VK.VK_RESERVED_C2,
      Win32VK.VK_OEM_4,
      Win32VK.VK_OEM_5,
      Win32VK.VK_OEM_6,
      Win32VK.VK_OEM_7,
      ...
      Win32VK.VK_OEM_102,
      Win32VK.VK_ICO_HELP,
      Win32VK.VK_PROCESSKEY,
      Win32VK.VK_ICO_CLEAR,
      Win32VK.VK_PACKET,
      Win32VK.VK_OEM_RESET,
      Win32VK.VK_OEM_JUMP,
      Win32VK.VK_OEM_PA1,
      Win32VK.VK_OEM_PA2,
      Win32VK.VK_OEM_PA3,
      Win32VK.VK_OEM_WSCTRL,
      Win32VK.VK_OEM_CUSEL,
      Win32VK.VK_OEM_ATTN,
      Win32VK.VK_OEM_FINISH,
      Win32VK.VK_OEM_COPY,
      Win32VK.VK_OEM_AUTO,
      Win32VK.VK_OEM_ENLW,
      Win32VK.VK_OEM_BACKTAB,
      Win32VK.VK_ATTN,
      Win32VK.VK_CRSEL,
      Win32VK.VK_EXSEL,
      Win32VK.VK_EREOF,
   ...
   public static final WinDef.HWND createWindow(
      String className,
      String windowName,
      int style,
      int x,
   ...
   public static final WinDef.HWND createWindowEx(
      int exStyle,
      String className,
      String windowName,
      int style,
      ...
      if (target == null) {
         ...
         if (0 == x) {
            ...
            return W32APITypeMapper.DEFAULT == W32APITypeMapper.UNICODE
               ? new String(lpBuffer.getPointer(0L).getCharArray(0L, x))
               : new String(lpBuffer.getPointer(0L).getByteArray(0L, x), Native.getDefaultStringEncoding());
         }
      }
   }
      ...
      public <V> Future<V> runAsync(Callable<V> command) {
         while (this.nativeThreadId == 0) {
            try {
               ...
               Logger.getLogger(User32Util.MessageLoopThread.class.getName()).log(Level.SEVERE, null, var3);
            }
         }
      ...
      public <V> V runOnThread(Callable<V> callable) throws Exception {
         while (this.javaThreadId == 0L) {
            try {
               ...
               Logger.getLogger(User32Util.MessageLoopThread.class.getName()).log(Level.SEVERE, null, var5);
            }
         }
