...
public interface Kernel32 extends StdCallLibrary, WinNT, Wincon {
   ...
   boolean ReadDirectoryChangesW(
      WinNT.HANDLE var1,
      WinNT.FILE_NOTIFY_INFORMATION var2,
      int var3,
      boolean var4,
      int var5,
      IntByReference var6,
      WinBase.OVERLAPPED var7,
      WinNT.OVERLAPPED_COMPLETION_ROUTINE var8
   );
   ...
   boolean CreateProcess(
      String var1,
      String var2,
      WinBase.SECURITY_ATTRIBUTES var3,
      WinBase.SECURITY_ATTRIBUTES var4,
      boolean var5,
      WinDef.DWORD var6,
      Pointer var7,
      String var8,
      WinBase.STARTUPINFO var9,
      WinBase.PROCESS_INFORMATION var10
   );
   ...
   WinNT.HANDLE CreateRemoteThread(
      WinNT.HANDLE var1, WinBase.SECURITY_ATTRIBUTES var2, int var3, WinBase.FOREIGN_THREAD_START_ROUTINE var4, Pointer var5, WinDef.DWORD var6, Pointer var7
   );

   WinNT.HANDLE CreateRemoteThread(
      WinNT.HANDLE var1, WinBase.SECURITY_ATTRIBUTES var2, int var3, Pointer var4, Pointer var5, int var6, WinDef.DWORDByReference var7
   );
