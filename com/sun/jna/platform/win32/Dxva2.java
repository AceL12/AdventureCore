...
public interface Dxva2 extends StdCallLibrary, PhysicalMonitorEnumerationAPI, HighLevelMonitorConfigurationAPI, LowLevelMonitorConfigurationAPI {
   Map<String, Object> DXVA_OPTIONS = Collections.unmodifiableMap(
               ...
               new DefaultTypeMapper() {
                  {
                     this.addTypeConverter(
                        HighLevelMonitorConfigurationAPI.MC_POSITION_TYPE.class, new EnumConverter<>(HighLevelMonitorConfigurationAPI.MC_POSITION_TYPE.class)
                     );
                     this.addTypeConverter(
                        HighLevelMonitorConfigurationAPI.MC_SIZE_TYPE.class, new EnumConverter<>(HighLevelMonitorConfigurationAPI.MC_SIZE_TYPE.class)
                     );
                     this.addTypeConverter(
                        HighLevelMonitorConfigurationAPI.MC_GAIN_TYPE.class, new EnumConverter<>(HighLevelMonitorConfigurationAPI.MC_GAIN_TYPE.class)
                     );
                     this.addTypeConverter(
                        HighLevelMonitorConfigurationAPI.MC_DRIVE_TYPE.class, new EnumConverter<>(HighLevelMonitorConfigurationAPI.MC_DRIVE_TYPE.class)
                     );
                  }
               }
            );
   ...
   WinDef.BOOL GetMonitorRedGreenOrBlueDrive(
      WinNT.HANDLE var1,
      HighLevelMonitorConfigurationAPI.MC_DRIVE_TYPE var2,
      WinDef.DWORDByReference var3,
      WinDef.DWORDByReference var4,
      WinDef.DWORDByReference var5
   );

   WinDef.BOOL GetMonitorRedGreenOrBlueGain(
      WinNT.HANDLE var1,
      HighLevelMonitorConfigurationAPI.MC_GAIN_TYPE var2,
      WinDef.DWORDByReference var3,
      WinDef.DWORDByReference var4,
      WinDef.DWORDByReference var5
   );
   ...
   WinDef.BOOL GetMonitorDisplayAreaSize(
      WinNT.HANDLE var1,
      HighLevelMonitorConfigurationAPI.MC_SIZE_TYPE var2,
      WinDef.DWORDByReference var3,
      WinDef.DWORDByReference var4,
      WinDef.DWORDByReference var5
   );

   WinDef.BOOL GetMonitorDisplayAreaPosition(
      WinNT.HANDLE var1,
      HighLevelMonitorConfigurationAPI.MC_POSITION_TYPE var2,
      WinDef.DWORDByReference var3,
      WinDef.DWORDByReference var4,
      WinDef.DWORDByReference var5
   );
   ...
   WinDef.BOOL GetVCPFeatureAndVCPFeatureReply(
      WinNT.HANDLE var1,
      WinDef.BYTE var2,
      LowLevelMonitorConfigurationAPI.MC_VCP_CODE_TYPE.ByReference var3,
      WinDef.DWORDByReference var4,
      WinDef.DWORDByReference var5
   );
