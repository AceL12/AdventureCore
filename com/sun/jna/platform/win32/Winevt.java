   ...
   public static class EVT_VARIANT extends Structure {
      ...
      public Object getValue() {
         ...
         switch (type) {
            case EvtVarTypeAnsiString:
               return this.isArray()
                  ? this.field1.getPointer().getPointer(0L).getStringArray(0L, this.Count)
                  : this.field1.getPointer().getPointer(0L).getString(0L);
            case EvtVarTypeBoolean:
               if (!this.isArray()) {
            ...
            case EvtVarTypeEvtXml:
               return this.isArray()
                  ? this.field1.getPointer().getPointer(0L).getWideStringArray(0L, this.Count)
                  : this.field1.getPointer().getPointer(0L).getWideString(0L);
            case EvtVarTypeSByte:
            case EvtVarTypeByte:
