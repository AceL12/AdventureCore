...
public interface X11 extends Library {
   ...
   boolean XQueryPointer(
      X11.Display var1,
      X11.Window var2,
      X11.WindowByReference var3,
      X11.WindowByReference var4,
      IntByReference var5,
      IntByReference var6,
      IntByReference var7,
      IntByReference var8,
   ...
   boolean XTranslateCoordinates(
      X11.Display var1, X11.Window var2, X11.Window var3, int var4, int var5, IntByReference var6, IntByReference var7, X11.WindowByReference var8
   );
   ...
   int XGetWindowProperty(
      ...
      boolean var6,
      X11.Atom var7,
      X11.AtomByReference var8,
      IntByReference var9,
      NativeLongByReference var10,
      NativeLongByReference var11,
      PointerByReference var12
   );
   ...
   public static class Visual extends PointerType {
      public X11.VisualID getVisualID() {
         if (this.getPointer() != null) {
            return new X11.VisualID(this.getPointer().getNativeLong(Native.POINTER_SIZE).longValue());
         } else {
   ...
   @Structure.FieldOrder(
      {"type", "serial", "send_event", "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", "state", "button", "same_screen"}
   )
   ...
   @Structure.FieldOrder(
      {"type", "serial", "send_event", "display", "event", "window", "x", "y", "width", "height", "border_width", "above", "override_redirect"}
   )
   ...
   @Structure.FieldOrder(
      {"type", "serial", "send_event", "display", "parent", "window", "x", "y", "width", "height", "border_width", "above", "detail", "value_mask"}
   )
   ...
   @Structure.FieldOrder(
      {"type", "serial", "send_event", "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", "state", "keycode", "same_screen"}
   )
   ...
   public interface XTest extends Library {
      X11.XTest INSTANCE = Native.load("Xtst", X11.XTest.class);
   ...
   public interface Xevie extends Library {
      X11.Xevie INSTANCE = Native.load("Xevie", X11.Xevie.class);
   ...
   public interface Xext extends Library {
      X11.Xext INSTANCE = Native.load("Xext", X11.Xext.class);
      int ShapeBounding = 0;
      int ShapeClip = 1;
      int ShapeInput = 2;
      int ShapeSet = 0;
   ...
   public interface Xrender extends Library {
      X11.Xrender INSTANCE = Native.load("Xrender", X11.Xrender.class);
