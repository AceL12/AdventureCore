...
public abstract class Structure {
   ...
   private final Map<String, Structure.NativeStringTracking> nativeStrings = new HashMap<>(8);
   ...
   protected Object readField(Structure.StructField structField) {
      ...
      if (fieldType.equals(String.class) || fieldType.equals(WString.class)) {
         if (result != null) {
            ...
            Structure.NativeStringTracking previous = this.nativeStrings.put(structField.name, current);
            if (previous != null) {
   ...
   protected List<String> getFieldOrder() {
      ...
      for (Class<?> clazz = this.getClass(); clazz != Structure.class; clazz = clazz.getSuperclass()) {
         Structure.FieldOrder order = clazz.getAnnotation(Structure.FieldOrder.class);
         if (order != null) {
   ...
   public Structure[] toArray(Structure[] array) {
      ...
      for (int i = 1; i < array.length; i++) {
         array[i] = newInstance((Class<Structure>)this.getClass(), this.memory.share(i * size, size));
   ...
   public static <T extends Structure> T newInstance(Class<T> type, Pointer init) throws IllegalArgumentException {
      try {
         ...
         throw new IllegalArgumentException(msgx, var6);
      } catch (InvocationTargetException var7) {
         String msgxx = "Exception thrown while instantiating an instance of " + type;
         throw new IllegalArgumentException(msgxx, var7);
      }
   ...
   static class FFIType extends Structure {
      private static final Map<Class, Map<Integer, Structure.FFIType>> typeInfoMap = new WeakHashMap<>();
      ...
      private static boolean isIntegerType(Structure.FFIType type) {
         ...
         return typePointer.equals(Structure.FFIType.FFITypes.ffi_type_uint8)
            || typePointer.equals(Structure.FFIType.FFITypes.ffi_type_sint8)
            || typePointer.equals(Structure.FFIType.FFITypes.ffi_type_uint16)
            || typePointer.equals(Structure.FFIType.FFITypes.ffi_type_sint16)
            || typePointer.equals(Structure.FFIType.FFITypes.ffi_type_uint32)
            || typePointer.equals(Structure.FFIType.FFITypes.ffi_type_sint32)
            || typePointer.equals(Structure.FFIType.FFITypes.ffi_type_uint64)
            || typePointer.equals(Structure.FFIType.FFITypes.ffi_type_sint64)
      ...
      public FFIType(Structure ref) {
         ...
         if (ref instanceof Union) {
            ...
            for (Structure.StructField sf : ref.fields().values()) {
               Structure.FFIType type = ref.getFieldTypeInfo(sf);
            ...
            if ((Platform.isIntel() && Platform.is64Bit() && !Platform.isWindows() || Platform.isARM() || Platform.isLoongArch())
               && hasInteger
               && isFloatType(unionType)) {
               unionType = new Structure.FFIType(unionType);
               if (unionType.size.intValue() == 4) {
                  unionType.type = ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_uint32).type;
               } else if (unionType.size.intValue() == 8) {
                  unionType.type = ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_uint64).type;
               }
      ...
      private static Structure.FFIType get(Object obj, Class<?> cls) {
         ...
         synchronized (typeInfoMap) {
            Structure.FFIType o = getTypeInfo(cls, cls.isArray() ? Array.getLength(obj) : 0);
            if (o != null) {
               return o;
      ...
      private static Structure.FFIType getTypeInfo(Class clazz, int elementCount) {
         Map<Integer, Structure.FFIType> typeMap = typeInfoMap.get(clazz);
         return typeMap != null ? typeMap.get(elementCount) : null;
      }

      private static void storeTypeInfo(Class clazz, Structure.FFIType type) {
         storeTypeInfo(clazz, 0, type);
      }

      private static void storeTypeInfo(Class clazz, int elementCount, Structure.FFIType type) {
         synchronized (typeInfoMap) {
            Map<Integer, Structure.FFIType> typeMap = typeInfoMap.get(clazz);
            if (typeMap == null) {
               typeMap = new HashMap<>();
      ...
      static {
         if (Native.POINTER_SIZE == 0) {
            ...
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_float, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_float)
            );
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_double, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_double)
            );
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_longdouble, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_longdouble)
            );
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_uint8, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_uint8)
            );
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_sint8, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_sint8)
            );
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_uint16, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_uint16)
            );
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_sint16, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_sint16)
            );
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_uint32, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_uint32)
            );
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_sint32, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_sint32)
            );
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_uint64, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_uint64)
            );
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_sint64, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_sint64)
            );
            ffiTypeInfo.put(
               Structure.FFIType.FFITypes.ffi_type_pointer, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_pointer)
            );

            for (Structure.FFIType f : ffiTypeInfo.values()) {
               f.read();
            }

            storeTypeInfo(void.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_void));
            storeTypeInfo(Void.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_void));
            storeTypeInfo(float.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_float));
            storeTypeInfo(Float.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_float));
            storeTypeInfo(double.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_double));
            storeTypeInfo(Double.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_double));
            storeTypeInfo(long.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_sint64));
            storeTypeInfo(Long.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_sint64));
            storeTypeInfo(int.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_sint32));
            storeTypeInfo(Integer.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_sint32));
            storeTypeInfo(short.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_sint16));
            storeTypeInfo(Short.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_sint16));
            Structure.FFIType ctype = Native.WCHAR_SIZE == 2
               ? ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_uint16)
               : ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_uint32);
            storeTypeInfo(char.class, ctype);
            storeTypeInfo(Character.class, ctype);
            storeTypeInfo(byte.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_sint8));
            storeTypeInfo(Byte.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_sint8));
            storeTypeInfo(Pointer.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_pointer));
            storeTypeInfo(String.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_pointer));
            storeTypeInfo(WString.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_pointer));
            storeTypeInfo(boolean.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_uint32));
            storeTypeInfo(Boolean.class, ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_uint32));
         }
      }
