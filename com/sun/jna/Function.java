      ...
      if (returnType == null || returnType == void.class || returnType == Void.class) {
         ...
         if (Structure.class.isAssignableFrom(returnType)) {
            if (Structure.ByValue.class.isAssignableFrom(returnType)) {
               Structure s = Native.invokeStructure(this, this.peer, callFlags, args, Structure.newInstance((Class<Structure>)returnType));
               s.autoRead();
               result = s;
            } else {
               result = this.invokePointer(callFlags, args);
               if (result != null) {
                  Structure s = Structure.newInstance((Class<Structure>)returnType, (Pointer)result);
