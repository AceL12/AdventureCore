...
public class Pointer {
   ...
   public void read(long offset, Pointer[] buf, int index, int length) {
      for (int i = 0; i < length; i++) {
         Pointer p = this.getPointer(offset + i * Native.POINTER_SIZE);
   ...
   Object getValue(long offset, Class<?> type, Object currentValue) {
      ...
      if (Structure.class.isAssignableFrom(type)) {
         ...
         if (Structure.ByReference.class.isAssignableFrom(type)) {
            s = Structure.updateStructureByReference((Class<Structure>)type, s, this.getPointer(offset));
         } else {
   ...
   private void readArray(long offset, Object o, Class<?> cls) {
      ...
      if (cls == byte.class) {
         ...
         if (Structure.ByReference.class.isAssignableFrom(cls)) {
            ...
            if (first == null) {
               first = Structure.newInstance((Class<Structure>)cls, this.share(offset));
