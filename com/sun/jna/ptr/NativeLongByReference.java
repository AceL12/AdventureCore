...
public class NativeLongByReference extends ByReference {
   ...
   public String toString() {
      return NativeLong.SIZE > 4
         ? String.format("NativeLong@0x1$%x=0x%2$x (%2$d)", Pointer.nativeValue(this.getPointer()), this.getValue().longValue())
         : String.format("NativeLong@0x1$%x=0x%2$x (%2$d)", Pointer.nativeValue(this.getPointer()), this.getValue().intValue());
   }
}
