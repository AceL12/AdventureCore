...
public abstract class ByReference extends PointerType {
   ...
   public String toString() {
      try {
         ...
         return value == null
            ? String.format("null@0x%x", Pointer.nativeValue(this.getPointer()))
            : String.format("%s@0x%x=%s", value.getClass().getSimpleName(), Pointer.nativeValue(this.getPointer()), value);
