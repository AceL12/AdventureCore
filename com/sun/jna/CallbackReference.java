...
public class CallbackReference extends WeakReference<Callback> implements Closeable {
   ...
   static void disposeAll() {
      for (Reference<CallbackReference> r : new LinkedList<>(allocatedMemory.values())) {
         ...
         if (value instanceof Pointer) {
            if (dstType == String.class) {
               ...
               if (Structure.ByValue.class.isAssignableFrom(dstType)) {
                  Structure s = Structure.newInstance((Class<Structure>)dstType);
                  ...
                  Structure s = Structure.newInstance((Class<Structure>)dstType, (Pointer)value);
